...
public class RobotContainer {
 ...
 private void configureBindings() {
    ...
    joy4.povUp().whileTrue(new InstantCommand(() -> armSubsystem.goToAngle(Const.Arm.UP_ANGLE))).onFalse(new InstantCommand(() -> armSubsystem.stop()));
    joy4.povDown().whileTrue(new InstantCommand(() -> armSubsystem.goToAngle(Const.Arm.DOWN_ANGLE))).onFalse(new InstantCommand(() -> armSubsystem.stop()));
