...
public class Constants {
        ...
        public static boolean isRed = NetworkTableInstance.getDefault().getTable("FMSInfo").getEntry("IsRedAlliance")
                        .getBoolean(true);
        ...
        public static final double kMaxAngularVelocity = kMaxVelocity
                        / Math.hypot(DRIVE_TRAIN_LENGTH / 2.0, DRIVE_TRAIN_WIDTH / 2.0);
        public static final double kMaxAngularAccel = kMaxAngularVelocity;
        public static final TrapezoidProfile.Constraints kTurnControlConstraints = new TrapezoidProfile.Constraints(
                        kMaxAngularVelocity, kMaxAngularAccel);
        public static final SupplyCurrentLimitConfiguration kdriveCurrentLimit = new SupplyCurrentLimitConfiguration(
                        true,
                        60, 60, 0);
        ...
        public static final double[] rightScore = new double[] { -0.88, -0.56, 180 };
        ...
        // public static final double[] lowScorePose = new double[]
        // {0.8156105103969574,-37.76153564453125,0.488794595003128};
        public static final double[] lowScorePose = new double[] { 0.809765040874481, -30.428321838378906,
                        0.495485693216324 };
        public static final double[] pickupPose = new double[] { 0.81150432062149, -20.809432983398438,
                        0.486733729839325 };
        public static final double[] transportPose = new double[] { 0.88200432062149, -10, 0.552061796188354 };
        // public static final double[] floorPose = new double[]
        // {0.684879839420319,-12.880990028381348,0.404875934123993}; //old floor pose
        // -Bruce
        public static final double[] floorPose = new double[] { 0.684879839420319, -12.880990028381348, 0.35 }; // new
                                                                                                                // floor
                                                                                                                // pose
                                                                                                                // -Bruce
        // public static final double[] startPose = new double[]
        // {0.900431036949158,-20,0.120892271399498}; //old position - BEn
        public static final double[] startPose = new double[] { 0.888, -20, 0.123850924730301 }; // adjusted position -
                                                                                                 // Ben
