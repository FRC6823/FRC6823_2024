...
public class AutoCommandGroup extends SequentialCommandGroup {
    ...
    public AutoCommandGroup(RobotContainer container, int auto) {
        ...
        if (auto == 1) {
            ...
            addCommands(new InstantCommand(() -> positionHandler.setPose(4)), new WaitCommand(2.5),
                    new InstantCommand(() -> pneumatic.togglePneumaticState()));
            addCommands(new WaitCommand(0.2), new InstantCommand(() -> positionHandler.setPose(2)),
                    new WaitCommand(0.5));
        } else if (auto == 2) {
            addCommands(new InstantCommand(() -> positionHandler.setPose(5)), new WaitCommand(0.5));
            addCommands(new InstantCommand(() -> positionHandler.setPose(4)), new WaitCommand(2.5),
            ...
            addCommands(new WaitCommand(0.2), new InstantCommand(() -> positionHandler.setPose(2)),
                    new WaitCommand(0.5));
            addCommands(new WaitCommand(0.5), new Unbalance(pigeon, swerve), new Reverse(swerve, pigeon, 0.7, 2),
                    new Rebalance(pigeon, swerve));
            addCommands(new WaitCommand(15));
        } else if (auto == 4) {
            addCommands(new InstantCommand(() -> positionHandler.setPose(5)), new WaitCommand(0.5));
            addCommands(new InstantCommand(() -> positionHandler.setPose(4)), new WaitCommand(2.5),
            ...
            addCommands(new InstantCommand(() -> positionHandler.setPose(4)), new WaitCommand(2),
                    new InstantCommand(() -> pneumatic.togglePneumaticState()));
            addCommands(new WaitCommand(0.2), new InstantCommand(() -> positionHandler.setPose(2)),
                    new WaitCommand(0.5));
            addCommands(new Unbalance(pigeon, swerve), new Over(pigeon, swerve), new Reverse(swerve, pigeon, 1, 1.5),
                    new ReUnbalance(pigeon, swerve), new Reverse(swerve, pigeon, 0.8, -2),
                    new Rebalance(pigeon, swerve));
        } else {
